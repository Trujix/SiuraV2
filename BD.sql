...
CREATE TABLE [dbo].[pacienteregistro](
	...
	[telefonotrabajopariente] [float] NULL,
	[celularpariente] [float] NULL,
	[estatus] [int] NOT NULL DEFAULT 1,
	[fechahora] [datetime] NULL,
	[admusuario] [varchar](50) NULL,
...
CREATE TABLE [dbo].[pacientedatosgenerales](
	...
	[drogaingresa] [varchar](200) NOT NULL,
	...
	[revisionfisica] [varchar](MAX) NOT NULL,
	[malesfisicos] [bit] NOT NULL DEFAULT 'False',
	[malespsiquiatricos] [bit] NOT NULL DEFAULT 'False',
	[malesgraves] [bit] NOT NULL DEFAULT 'False',
	[malescontagiosos] [bit] NOT NULL DEFAULT 'False',
	[otrosmales] [varchar](MAX) NOT NULL,
	[tomamedicinas] [bit] NOT NULL DEFAULT 'False',
	[medicinamales] [varchar](MAX) NOT NULL,
	[fechahora] [datetime] NULL,
	[admusuario] [varchar](50) NULL,
